...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/kunst
```

A live public deployment of this template is available at [https://kunst.templates.workers.dev](https://kunst.templates.workers.dev)
